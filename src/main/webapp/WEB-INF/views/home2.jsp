...
<html class="no-js" lang="zxx">
    ...
    <body>
			...
			<div class="slider-area">
				<div class="bend niceties preview">
					<div id="ensign-nivoslider" class="slides">	
						...
						<img src="resources/img/slider/2.jpg" alt="" title="#slider-direction-1"  />
					</div>
					<!-- direction 1 -->
					<div id="slider-direction-1" class="slider-direction">
						<div class="slider-content text-center s-tb slider-1">
							<div class="title-container s-tb-c title-compress">
								...
								<h1 class="title1">sopzon 2017 collections</h1>
		...
		<div class="page-content-wrapper">
            ...
            <div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >手机?站模板</a></div>
		...
		<footer>
			...
			<div class="footer-bottom-area black-bg">
				<div class="container">
					<div class="row ">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<p>Copyright &copy; 2017.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="??模板" target="_blank">??模板</a></p>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
