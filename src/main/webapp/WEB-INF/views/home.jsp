				...
				<div id="slider-direction-1" class="slider-direction">
					<div class="slider-content text-center s-tb slider-1">
						<div class="title-container s-tb-c title-compress">
							<h2 class="title2"><span class="NanumGothicBold">어떤 케이크</span>가 필요하세요?</h2>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="instragam-single">
								...
								<h3 class="tag-text"><a>#고소한</a></h3>
								<div class="instragam-content text-center text-white">
									<a class="popup-instragram" href="/resources/img/instragram/1.jpg"></a>
									<h3 class="tag-text"><a>#고소한</a></h3>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="single-service mt-50">
								...
								<h4>국내 최초 케이크 플랫폼 </h4>
								<p>가게 마다 다른 홈페이지, 모든 가게의 케이크를 한눈에 볼 수 는 없을까? 이제 LikeyCakey'에서 전국의 모든 케이크를 검색, <br>
								     주문해보세요. 당신의 기념일이 훨씬 윤택해질 것입니다.</p>
							</div>
						</div>
						<div class="col-md-4 hidden-sm hidden-xs">
							<div class="single-service middle-border mt-50">
								...
								<p>다 똑같은 케이크는 재미없습니다. <br>
								     빵, 토핑, 크림 등 원하는 재료로  각자의 개성에 맞게 케이크를<br>
								     제작해보세요.</p>
							</div>
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="single-service mt-50">
								...
								<h4>케이크 필터 검색 서비스</h4>
								<p>다양한 케이크의 종류를 필터를 이용해 편리하게 검색해 보세요. <br>
								     내가 원하는 케이크를 조금 더 쉽게 찾을 수 있습니다.</p>
							</div>
						</div>
					</div>
				</div>
